        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkilId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillDependencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillDependencies_Skills_SkilId",
                        column: x => x.SkilId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SkillDependencies_Skills_SkilId1",
                        column: x => x.SkilId1,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillDependencies_SkilId",
                table: "SkillDependencies",
                column: "SkilId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillDependencies_SkilId1",
                table: "SkillDependencies",
                column: "SkilId1");
